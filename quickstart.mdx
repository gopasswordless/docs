...
<AccordionGroup>
  ...
  <Accordion icon="message-bot" title="Installing Our Github App">
    ...
    The next step is to install our Github app. This ensures that your updates are automatically deployed when you push changes. You can find the installation link in the [dashboard](https://dashboard.mintlify.com), under the Settings dropdown. Upon successful installation, a check mark will appear next to the commit hash of the repository.
